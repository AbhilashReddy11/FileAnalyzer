...
namespace FileAnalyzer.Controllers
{
    public class HomeController : Controller
    {
        //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
        ...
        [HttpPost]
        public async Task<IActionResult> AnalyzeFile(InputOutputModel model, IFormFile file)
        {
            try
            {
